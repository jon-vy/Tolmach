...
# output language_map
#print(f'output language_map {ts._deepl.language_map}')

# professional field
print(ts.google(wyw_text, professional_field='general', from_language='auto', to_language='ru')) # ("general","message","offer")
